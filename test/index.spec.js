    ...
    describe('When parsing binary data', () => {
        ...
        describe('and handling any of the 24-bit numerical types', () => {
            it('should be able to parse them to Number values', () => {
                ...
                const { data, end, error } = parseByteArray( byteArray, { value: types.INT24 });
                expect( error ).toBe( false );
            ...
            it('should be able to parse multiple entries to Arrays of Number values', () => {
                ...
                const { data, end, error } = parseByteArray( byteArray, { value: 'INT24[2]' });
                expect( error ).toBe( false );
            ...
            it('should be able to parse both Little Endian and Big Endian values', () => {
                ...
                expect( parseByteArray( byteArrayLE, { value: 'INT24|LE' }).data.value ).toEqual( 14545151 );
                expect( parseByteArray( byteArrayBE, { value: 'INT24|BE' }).data.value ).toEqual( 14545151 );
            });
        });
